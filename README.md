...
Official implementation for <b>LongMINT: Evaluating Memory under Multi-Target Interference in Long-Horizon Agent Systems</b>.

LongMINT is a benchmark for evaluating memory-augmented agents under interference-heavy context over four different domains (state tracking, multi-turn dialogue, Wikipedia revisions, and GitHub commits) with five question types (Simple, History, Ordering, Counting, and Multihop).
...
Some baselines maintain their own environments and dependencies.
Please follow the setup instructions in their official repositories:

  - [Mem-alpha github](https://github.com/wangyu-ustc/Mem-alpha)
  - [MemAgent github](https://github.com/BytedTsinghua-SIA/MemAgent)
  - [AtomMem github](https://github.com/RUCBM/AtomMem)

## Dataset

The LongMINT dataset is available on Hugging Face: [dinobby/LongMINT](https://huggingface.co/datasets/dinobby/LongMINT)

## Supported Baselines

| Runner | Entry point | References |
| --- | --- | --- |
| **Full-context** | [src/fullcontext/run_fullcontext_unified.py](src/fullcontext/run_fullcontext_unified.py) | - |
| **BaseRAG** (dense) | [tests_baserag.py](tests_baserag.py) | - |
| **HippoRAG** | [tests_hipporag.py](tests_hipporag.py) | [HippoRAG2](https://arxiv.org/abs/2502.14802) |
| **MemAgent** | [src/memagent/run_memagent_unified.py](src/memagent/run_memagent_unified.py) | [MemAgent](https://arxiv.org/abs/2507.02259) |
| **AtomMem** | [src/atommem/run_atommem_unified.py](src/atommem/run_atommem_unified.py) | [AtomMem](https://arxiv.org/abs/2601.08323) |
| **Mem-alpha** | [run_memalpha_unified.py](run_memalpha_unified.py) | [Mem-alpha](https://arxiv.org/abs/2509.25911) |
...
We also recommend citing the original works that this repository builds upon:
```bibtex
